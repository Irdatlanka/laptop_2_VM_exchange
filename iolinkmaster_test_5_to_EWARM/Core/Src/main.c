...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, led_iolink1_g_Pin|led_iolink1_r_Pin|led_pwr_fault_Pin|usbdb__Pin
                          |tps272_en1_Pin|tps272_en2_Pin|tps272_latch_Pin|txena_Pin
  ...
  /*Configure GPIO pins : iolink_irq__Pin led_pwr_ok_Pin usbflt__Pin */
  GPIO_InitStruct.Pin = iolink_irq__Pin|led_pwr_ok_Pin|usbflt__Pin;
